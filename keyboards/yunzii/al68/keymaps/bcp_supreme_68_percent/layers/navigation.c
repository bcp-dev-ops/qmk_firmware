...
LAYOUT_65_ansi_blocker(
    ...
    KC_TAB,  MACRO_FOCUS_TAB_LEFT, MACRO_FOCUS_TAB_RIGHT, _______, MACRO_DUPLICATE, _______, _______, _______, _______, _______, _______, MACRO_FOCUS_PREVIOUS_WORKSHEET, MACRO_FOCUS_NEXT_WORKSHEET, _______, _______,
