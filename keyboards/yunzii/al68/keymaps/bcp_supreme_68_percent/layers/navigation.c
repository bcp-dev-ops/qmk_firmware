...
LAYOUT_65_ansi_blocker(
    ...
    TAB_TOGGLE_NAVIGATION_LAYER,  MACRO_FOCUS_TAB_LEFT, MACRO_FOCUS_TAB_RIGHT, _______, MACRO_DUPLICATE, _______, _______, _______, _______, _______, _______, MACRO_FOCUS_SPACE_LEFT, MACRO_FOCUS_SPACE_RIGHT, _______, _______,
