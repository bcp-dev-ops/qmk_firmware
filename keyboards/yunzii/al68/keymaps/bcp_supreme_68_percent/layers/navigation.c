...
LAYOUT_65_ansi_blocker(
    ...
    KC_TAB,  MACRO_FOCUS_TAB_LEFT, MACRO_FOCUS_TAB_RIGHT, MACRO_FOCUS_WINDOW_LEFT, MACRO_FOCUS_WINDOW_RIGHT, MACRO_FOCUS_SPACE_LEFT, MACRO_FOCUS_SPACE_RIGHT, _______, _______, _______, _______, MACRO_FOCUS_PREVIOUS_WORKSHEET, MACRO_FOCUS_NEXT_WORKSHEET, _______, _______,
